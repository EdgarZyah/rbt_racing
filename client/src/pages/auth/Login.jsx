    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-6">
      <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-1000">
        <div className="text-center mb-12">
          <h1 className="text-5xl font-black italic tracking-tighter uppercase mb-2">Welcome Back</h1>
          <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-[0.4em]">Secure Access to Your Armory</p>
        </div>
        ...
        <div className="mt-12 text-center space-y-4">
          <Link to="/register" className="block text-[9px] font-black uppercase tracking-widest text-zinc-400 hover:text-black transition-colors">
            Create New Armory Account
          </Link>
        </div>
      </div>
    </div>
